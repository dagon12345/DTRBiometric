...
{
    public partial class ReadCard_frm : Form
    {
        int retCode;
        int hCard;
        int hContext;
        ...
        private void ReadCard_frm_Load(object sender, EventArgs e)
        {
        ...
        public bool connectCard()
        {
            ...
            if (retCode != Card.SCARD_S_SUCCESS)
            {
                ...
                MessageBox.Show(Card.GetScardErrMsg(retCode), "Card Removed", MessageBoxButtons.OK, MessageBoxIcon.Error);
               //connActive = false;
                return false;
            }
            return true;
        ...
        private void ReadCardButton_Click(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select * from EmployeeDetails_db where RFIDNumber like'" + txtrfidnumber.Text + "'";
            cmd.ExecuteNonQuery();
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                {
                    lblemployeename.Text = "Empty Card.";
                    lbldepartment.Text = "Empty Card.";
        ...
        private void ReadCard_frm_FormClosed(object sender, FormClosedEventArgs e)
        {
            this.Dispose();
        }
